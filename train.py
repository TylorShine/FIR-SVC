...
from modules.vocoder import (
    CombSubMinimumResidual,
    NeuralResidual, NeuralHiFi,
    NSFMPAAHiFi, NMPAAHiFi,
    DirectNeXtV2, Direct2NeXtV2, Direct3NeXtV2,
)
...
if __name__ == '__main__':
    ...
    if args.model.type == 'CombSubMinimumNoisedPhase':
    ...
    elif args.model.type == 'CombSubMinimumResidual':
        if args.train.only_u2c_stack:
            model = CombSubMinimumNoisedPhaseStackOnly(
                n_unit=args.data.encoder_out_channels,
                n_hidden_channels=args.model.units_hidden_channels
            ...
            model.unit2ctrl.compile(mode="reduce-overhead")
            model.res_decoder.compile(mode="reduce-overhead")
            if args.model.use_discriminator:
                model_d = MultiPeriodSpecDiscriminator()
                
    elif args.model.type == 'NeuralResidual':
        if args.train.only_u2c_stack:
            model = CombSubMinimumNoisedPhaseStackOnly(
                n_unit=args.data.encoder_out_channels,
                n_hidden_channels=args.model.units_hidden_channels
        ...
        # model.unit2ctrl.compile(mode="reduce-overhead", fullgraph=True)
        # model.generator.compile(mode="reduce-overhead", fullgraph=True)
        # model.unit2ctrl.compile(mode="reduce-overhead", fullgraph=True)
    ...
    elif args.model.type == 'NSFMPAAHiFi':
        model = NSFMPAAHiFi(
            sampling_rate=args.data.sampling_rate,
            block_size=args.data.block_size,
            win_length=args.model.win_length,
            ...
            n_frames=args.model.nsf_hifigan.num_frames,
            use_speaker_embed=args.model.use_speaker_embed,
            use_embed_conv=not args.model.no_use_embed_conv,
            spk_embed_channels=args.data.spk_embed_channels,
            f0_input_variance=args.model.f0_input_variance,
    ...
    elif args.model.type == 'NMPAAHiFi':
        model = NMPAAHiFi(
            sampling_rate=args.data.sampling_rate,
            block_size=args.data.block_size,
            win_length=args.model.win_length,
    ...
    elif args.model.type == 'DirectNeXtV2':
        model = DirectNeXtV2(
            sampling_rate=args.data.sampling_rate,
            block_size=args.data.block_size,
            win_length=args.model.win_length,
    ...
    elif args.model.type == 'Direct2NeXtV2':
        model = Direct2NeXtV2(
            sampling_rate=args.data.sampling_rate,
            block_size=args.data.block_size,
            win_length=args.model.win_length,
    ...
    elif args.model.type == 'Direct3NeXtV2':
        model = Direct3NeXtV2(
            sampling_rate=args.data.sampling_rate,
            block_size=args.data.block_size,
            win_length=args.model.win_length,
    ...
    elif args.model.type == 'NeuralHiFi':
        model = NeuralHiFi(
            sampling_rate=args.data.sampling_rate,
            block_size=args.data.block_size,
            win_length=args.model.win_length,
