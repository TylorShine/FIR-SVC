...
@REM @REM SET MNP_VCTK_OPT0_DIR=https://huggingface.co/TylorShine/MNP-SVC-v2-VCTK/resolve/main/states/cp0/optimizer.bin
@REM @REM SET MNP_VCTK_OPT1_DIR=https://huggingface.co/TylorShine/MNP-SVC-v2-VCTK/resolve/main/states/cp0/optimizer_1.bin
@REM @REM SET MNP_VCTK_MODEL0_DIR=https://huggingface.co/TylorShine/MNP-SVC-v2-VCTK/resolve/main/states/cp0/pytorch_model.bin
@REM @REM SET MNP_VCTK_MODEL1_DIR=https://huggingface.co/TylorShine/MNP-SVC-v2-VCTK/resolve/main/states/cp0/pytorch_model_1.bin
@REM @REM SET MNP_VCTK_MODEL2_DIR=https://huggingface.co/TylorShine/MNP-SVC-v2-VCTK/resolve/main/states/cp0/pytorch_model_2.bin
@REM @REM SET MNP_VCTK_RND0_DIR=https://huggingface.co/TylorShine/MNP-SVC-v2-VCTK/resolve/main/states/cp0/random_states_0.pkl
@REM @REM SET MNP_VCTK_SCHED0_DIR=https://huggingface.co/TylorShine/MNP-SVC-v2-VCTK/resolve/main/states/cp0/scheduler.bin
@REM @REM SET MNP_VCTK_SCHED1_DIR=https://huggingface.co/TylorShine/MNP-SVC-v2-VCTK/resolve/main/states/cp0/scheduler_1.bin
@REM SET MNP_VCTK_MODEL_DIR=https://huggingface.co/TylorShine/MNP-SVC-v2-VCTK/resolve/main/pytorch_model.bin
@REM SET MNP_VCTK_CONF_DIR=https://huggingface.co/TylorShine/MNP-SVC-v2-VCTK/resolve/main/config.yaml
@REM SET MNP_VCTK_SPK_INFO_DIR=https://huggingface.co/TylorShine/MNP-SVC-v2-VCTK/resolve/main/spk_info.npz
@REM SET MNP_VCTK_DIR=%DOWNLOAD_MODEL_DIR%\mnp-svc\vctk-full
@REM IF NOT EXIST "%MNP_VCTK_DIR%" (
@REM     ECHO Info: Start downloading the MNP-SVC weights pretrained on VCTK dataset...
@REM     ECHO .
@REM     mkdir "%MNP_VCTK_DIR%"
@REM     CD /d "%MNP_VCTK_DIR%"
@REM     curl -L -O "%MNP_VCTK_MODEL_DIR%"
@REM     curl -L -O "%MNP_VCTK_CONF_DIR%"
@REM     curl -L -O "%MNP_VCTK_SPK_INFO_DIR%"
@REM     IF %ERRORLEVEL% neq 0 (
@REM         ECHO .
@REM         ECHO Error: Failed to download the MNP-SVC weights pretrained on VCTK dataset...
@REM         EXIT /b
@REM     )
@REM     CD /d %~dp0
@REM )
